...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.vantage.sh/v2";
    private String tokenUrl = "https://console.vantage.sh/account/profile";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.vantage.sh/v2)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://console.vantage.sh/account/profile)
     * @return An instance of OkHttpClient
     */

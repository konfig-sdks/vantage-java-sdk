 ...
 * Workspace model
 */
@ApiModel(description = "Workspace model")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Workspace {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Acme Corp.", value = "The name of the Workspace.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, workspace.token) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(token, name, additionalProperties);
  }

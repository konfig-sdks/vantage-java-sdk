 ...
 * Segments model
 */
@ApiModel(description = "Segments model")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Segments {
  ...
  public Segments links(Object links) {
  ...
  **/
   ...
   * @return the Segments instance itself
   */
  public Segments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, segments.links) &&
        Objects.equals(this.segments, segments.segments)&&
        Objects.equals(this.additionalProperties, segments.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, segments, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Segments
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Segments.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("segments") != null && !jsonObj.get("segments").isJsonNull()) {
        ...
        if (jsonArraysegments != null) {
          ...
          for (int i = 0; i < jsonArraysegments.size(); i++) {
            Segment.validateJsonObject(jsonArraysegments.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Segments>() {
           ...
           public Segments read(JsonReader in) throws IOException {
             ...
             Segments instance = thisAdapter.fromJsonTree(jsonObj);
